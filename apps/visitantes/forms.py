...
class VisitanteForm (forms.ModelForm):
    class Meta:
        ...
        error_messages={
            ...
            "data_nascimento":{
                "required":"A data de nascimento é obrigatório para o registro",
...
class AutorizaVisistanteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        error_messages = {
            "morador_responsavel":{
                "required":"Por favor, informe o nome do morador responsável por autorizar a entrada do visistante"
            }
        }